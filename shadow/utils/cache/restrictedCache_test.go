...
func TestRestrictedCacheKey_Format(t *testing.T) {
	...
	cases := []struct {
		...
		{-1001618764357, "shadow:restricted:-1001618764357"},
		{123456789, "shadow:restricted:123456789"},
		{0, "shadow:restricted:0"},
	}
...
func TestRestrictedProbeKey_Format(t *testing.T) {
	...
	cases := []struct {
		...
		{123456789, "shadow:restricted_probe:123456789"},
		{0, "shadow:restricted_probe:0"},
	}
...
func TestRestrictedProbeKey_NilSafe(t *testing.T) {
	...
	want := "shadow:restricted_probe:12345"
	if got != want {
