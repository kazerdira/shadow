...
Filters are case insensitive; every time someone says your trigger words, shadow will reply something else! This can be used to create your commands, if desired.
